  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.editButtonContainer}>
          <TouchableOpacity style={styles.editBtn}onPress={() => {
                                                        router.push('/pond_form/Basic details pond');
                                                      }}>
      ...
      <View style={styles.card}>
        ...
        {renderField('38. Length in meter', '')}
        {renderField('39. Bredth in meter', '')}
        {renderField('40. Depth in meter', '')}
        {renderField('41. Volume of Excavation', '')}
