...
export default function PreviewPage() {
  ...
  {/* <Text style={styles.photoLabel}>Photo of the Farmer</Text> */}
        ...
        {renderField('1. District', '')}
        {renderField('3. Block', '')}
        {renderField('4. Panchayat', '')}
        {renderField('5. Hamlet', '')}
      ...
      <View style={styles.card}>
        ...
        {renderField('28. Taluk', '')}
        {renderField('28. Firka', '')}
        {renderField('28. Revenue Village', '')}
        {renderField('29. Crop Season', '')}
        <View style={styles.item}>
          <Text style={styles.label}>30. Livestock at Home (ha)</Text>
      ...
      <View style={styles.card}>
        ...
        {renderField('38. Type of work proposed', '')}
